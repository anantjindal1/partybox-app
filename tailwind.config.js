  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        cobalt: 'rgb(var(--color-accent-cobalt-rgb) / <alpha-value>)',
        amber: 'rgb(var(--color-accent-amber-rgb) / <alpha-value>)',
        cerulean: 'rgb(var(--color-accent-cerulean-rgb) / <alpha-value>)',
        taupe: 'rgb(var(--color-accent-taupe-rgb) / <alpha-value>)',
        ...
        onCobalt: 'rgb(var(--on-cobalt-rgb) / <alpha-value>)',
        onAmber: 'rgb(var(--on-amber-rgb) / <alpha-value>)',
        onCerulean: 'rgb(var(--on-cerulean-rgb) / <alpha-value>)',
        onTaupe: 'rgb(var(--on-taupe-rgb) / <alpha-value>)',
        onSage: 'rgb(var(--on-sage-rgb) / <alpha-value>)',
      ...
      animation: {
        ...
        'hand-settle': 'hand-settle 1.5s ease-in forwards'
      }
    }
  },
  plugins: []
