/**
 * Bollywood Emoji Guess state machine. Pure reducer, no side effects.
 * Phases: setup | question_show | answer_selected | show_result | session_end
...
export function bollywoodEmojiGuessReducer(state, action) {
  switch (action.type) {
    ...
    case ACTIONS.TIMEOUT: {
      ...
      const newAnswers = [...state.answers, { correct: false, selectedIndex: -1, responseTimeMs: TIMEOUT_MS, points: 0 }]
      return {
        ...state,
        phase: 'answer_selected',
        score: state.score,
